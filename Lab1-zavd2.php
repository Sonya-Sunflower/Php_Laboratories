...
$students = array(
    new Student("John Doe", 2, "ABC123", 1000),
    new Student("Jane Smith", 3, "DEF456", 1200),
    new Student("Michael Johnson", 1, "GHI789", 900),
    new Student("Emily Davis", 4, "JKL012", 1500),
    new Student("David Wilson", 2, "MNO345", 1100)
);
